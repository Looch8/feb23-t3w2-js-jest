...
describe("Tabletop RPG gamer...", () => {
	...
	test("...wants to roll a D20 with disadvantage and see both roll results as well as the best roll", () => {});
	...
	describe("...wants to roll a variety of dice, specificially, they want to roll a ...", () => {
		let diceVarieties = [
			{ diceSize: 4, diceName: "D4" },
			{ diceSize: 6, diceName: "D6" },
			{ diceSize: 8, diceName: "D8" },
			{ diceSize: 10, diceName: "D10" },
			{ diceSize: 12, diceName: "D12" },
			{ diceSize: 20, diceName: "D20" },
			{ diceSize: 100, diceName: "D100" },
		];
